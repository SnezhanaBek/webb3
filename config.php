<?php
// config.php — подключение к базе данных + автоматическое создание таблиц
...
// Функция для автоматического создания таблиц (если их нет)
function initDatabaseIfNeeded(): void {
    ...
    // SQL для создания таблиц (init.sql)
    $sql = "
